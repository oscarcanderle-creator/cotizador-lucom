...
function hrefBandejaGrupo(bandeja: Bandeja) {
  ...
  return `/ventas-grupo?${params.toString()}`
}

export default function BandejasVentasGrupo({
  bandejas,
  filtrosActuales,
  puedeGuardar,
  bandejaActiva = '',
  ...
  const guardar = async () => {
    ...
    try {
      const respuesta = await fetch('/api/ventas-grupo/bandejas', {
        method: 'POST',
  ...
  return (
    <section className="mb-4 rounded-2xl border border-gray-200 bg-white p-4">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <h2 className="text-sm font-semibold text-gray-900">Bandejas del grupo</h2>
