...
export default async function SuperVentasPage({
  ...
  /*
   * SUPER requiere visión global. Usamos cliente ADMIN del lado servidor
   * solamente después de autenticar y validar rol ADMIN/SUPERVISOR.
   */
              ...
              {ventas.map((operacion: any) => (
                ...
                >
                  ...
                  <td className="px-2 py-3 text-right">
                    <a
                      href={`/super/ventas/${encodeURIComponent(
                        operacion.id_operacion
                      )}`}
