...
export default async function Page() {
  ...
  async function crearEstado(formData: FormData) {
    ...
    revalidatePath('/admin/estados-bboo')
    redirect('/admin/estados-bboo')
  }
  ...
  async function actualizarEstado(formData: FormData) {
    ...
    if (!Number.isFinite(id) || !nombre) {
      throw new Error('Datos de estado BBOO inválidos.')
    }
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Administrá los estados operativos utilizados por BBOO en Portabilidad y Línea Nueva.
            </p>
          </div>
