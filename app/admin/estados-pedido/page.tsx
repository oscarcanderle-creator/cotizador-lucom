...
export default async function Page() {
  ...
  const { data: estados, error } = await admin
    .from('estados_pedido')
    .select('id, codigo, nombre, tipo_estado, activo, orden')
    .order('orden')
    .order('nombre')
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 sm:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Administrá los estados disponibles para la gestión de pedidos.
            </p>
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[190px_1fr_190px_100px_auto] gap-3 xl:items-end">
            <div>
          ...
          {(estados ?? []).map((estado) => (
            ...
            >
              <form
                ...
                className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[190px_1fr_190px_100px_auto_auto] gap-3 xl:items-end"
              >
