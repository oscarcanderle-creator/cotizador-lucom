    ...
    <main className="min-h-screen bg-gray-100 text-gray-900">
      ...
      >
        ...
        <div className="mb-3 flex items-center gap-2 rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800">
          ...
          <span><strong>PLATAFORMA LUCOM</strong> · Las ventas BAF y PORTA se registran únicamente en la plataforma. La sincronización con Google Sheets está deshabilitada.</span>
        </div>
